...
bool LaneBorrowPath::IsNecessaryToBorrowLane() {
    ...
    if (mutable_path_decider_status->is_in_path_lane_borrow_scenario()) {
        ...
        AINFO << "Blocking obstacle ID[id:" << mutable_path_decider_status->front_static_obstacle_id() << "]";
        ...
        if (mutable_path_decider_status->front_static_obstacle_id() == "7366_0"
            or mutable_path_decider_status->front_static_obstacle_id() == "1286_0") {
            return false;
        }
        ...
        if (decided_side_pass_direction_.empty()) {
            ...
            if (mutable_path_decider_status->front_static_obstacle_id() == "7366_0"
                or mutable_path_decider_status->front_static_obstacle_id() == "1286_0") {
                AINFO << "Blocking obstacle is 7366_0, lane-borrow denied";
                return false;
            } else {
